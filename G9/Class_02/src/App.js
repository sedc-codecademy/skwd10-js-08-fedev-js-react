...
//   const myDiv = <div>I am div</div>;
//   return (
//     <div className="App">
//       <img src={user.imageUrl} alt="avatar" width={150} height={150} />
//       {renderCard(user)}
//       {renderTitle("HEADING ONE")}
//       {myDiv}
...
class App extends Component {
  // SOMETHING THAT WE WILL LEARN ABOUT NEXT CLASS (NE CEPKAJ!)
  // constructor() {
  //   super();
  //   this.state = {
  //     people: [],
  ...
  render() {
    ...
    return (
      <div>
        {/* 
        NE SE PLASI OVA E INTRO ZA NAREDEN CAS 
        ...
        <Title fullName={`${name} ${secondName}`} />
        <Card>
          <p>I am paragraph {<span>I am span</span>}</p>
